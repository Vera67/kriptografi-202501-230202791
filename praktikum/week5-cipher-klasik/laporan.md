...
3. Bandingkan kelebihan dan kelemahan cipher substitusi vs transposisi. | Tipe Cipher | Kelebihan | Kelemahan | | :--- | :--- | :--- | | Substitusi | Konfusi (Confusion): Mengaburkan hubungan antara plaintext dan ciphertext. Huruf-huruf diubah menjadi sesuatu yang sama sekali berbeda. | Mempertahankan Statistik (Monoalfabetik): Pola dan frekuensi huruf dari plaintext masih ada di ciphertext, membuatnya rentan terhadap analisis statistik. | | Transposisi | Difusi (Diffusion): Menyebarkan redundansi statistik dari plaintext ke area yang lebih luas di ciphertext. Merusak pola huruf lokal (misalnya, 'THE' bisa menjadi 'T...H...E'). | Tidak Mengubah Huruf: Frekuensi huruf di ciphertext sama persis dengan di plaintext, hanya urutannya yang diacak. Rentan terhadap serangan anagramming jika penyerang tahu bahwa ini adalah transposisi.|
---
